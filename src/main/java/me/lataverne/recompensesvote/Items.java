...
public enum Items {
    ...
    SHULKER_SHELL("shulker_shell", 0.1f, false),
    SHULKER_BOX("shulker_box", 0.08f, false),
    BIRCH_LOG("birch_log", 0.08f, false),
    SPRUCE_LOG("spruce_log", 0.08f, false),
    OAK_LOG("oak_log", 0.08f, false),
    ACACIA_LOG("acacia_log", 0.08f, false),
    JUNGLE_LOG("jungle_log", 0.08f, false),
    DARK_OAK_LOG("dark_oak_log", 0.08f, false),
    ELYTRA("elytra", 0.05f, false),
    NETHER_QUARTZ_ORE("nether_quartz_ore", 0.15f, false),
    ...
    CREEPER_POTION("creeper_potion", 0.05f, true),
    MINING_POTION("mining_potion", 0.1f, true),
    SWIMING_POTION("swiming_potion", 0.1f, true),
    ULU("ulu", 0f, true),
    INDIAN_SPEAR("indian_spear", 0f, true),
    BASEBALL_BAT("baseball_bat", 0.05f, true),
    GOBLIN_PICKAXE("goblin_pickaxe", 0.15f, true),
    GIANT_BOOTS("giant_boots", 0.05f, true),
    COOKED_HORSE("cooked_horse", 0f, true),
    COOKED_BEAR("cooked_bear", 0f, true),
    RAW_HORSE("raw_horse", 0f, true),
    RAW_BEAR("raw_bear", 0f, true),
    CANDY_CANE("candy_cane", 0f, true),
    STONE("stone", 0.15f, false),
    IRON_INGOT("iron_ingot", 0.2f, false),
    GOLD_INGOT("gold_ingot", 0.1f, false),
    DIAMOND("diamond", 0.05f, false),
    GRASS_BLOCK("grass_block", 0.15f, false),
    STONE_BRICKS("stone_bricks", 0.17f, false),
    BRICKS("bricks", 0.1f, false),
    SLIME_BALL("slime_ball", 0.1f, false),
    STICK("stick", 0.025f, false),
    DIAMOND_BLOCK("diamond_block", 0.025f, false),
    IRON_BLOCK("iron_block", 0.15f, false),
    GOLD_BLOCK("gold_block", 0.08f, false),
    BELL("bell", 0.1f, false),
    ANVIL("anvil", 0.1f, false),
    BOOK("book", 0.15f, false),
    STONE_HOE_U20("stone_hoe_u20", 0.01f, true);
    ...
    private Items(String name, Float rewardChance, Boolean isCustom) {
        ...
        switch (name) {
            ...
            case "acacia_log":
                item = new ItemStack(Material.ACACIA_LOG, 64);
                break;

            case "jungle_log":
                item = new ItemStack(Material.JUNGLE_LOG, 64);
                break;

            case "dark_oak_log":
                item = new ItemStack(Material.DARK_OAK_LOG, 64);
                break;
            ...
            case "gold_ingot":
                item = new ItemStack(Material.GOLD_INGOT, 12);
                break;
            ...
            case "grass_block":
                item = new ItemStack(Material.GRASS_BLOCK, 64);
                break;

            case "stone_bricks":
                item = new ItemStack(Material.STONE_BRICKS, 32);
                break;

            case "bricks":
                item = new ItemStack(Material.BRICKS, 32);
                break;

            case "slime_ball":
                item = new ItemStack(Material.SLIME_BALL, 16);
                break;
            ...
            case "iron_block":
                item = new ItemStack(Material.IRON_BLOCK, 3);
                break;

            case "gold_block":
                item = new ItemStack(Material.GOLD_BLOCK, 2);
                break;
            ...
            case "book":
                item = new ItemStack(Material.BOOK, 12);
                break;
            
            case "stone_hoe_u20":
                item = createStoneHoeUnbreaking();
                break;
    ...
    private ItemStack createFortuneBook() {
        ...
        itemMeta.addStoredEnchant(Enchantment.LOOT_BONUS_BLOCKS, 3, false);
