...
public class EntityHider implements Listener {
    ...
    private static final PacketType[] ENTITY_PACKETS = {
        PacketType.Play.Server.ENTITY_EQUIPMENT, PacketType.Play.Server.BLOCK_BREAK_ANIMATION,
        PacketType.Play.Server.ANIMATION, PacketType.Play.Server.NAMED_ENTITY_SPAWN,
        ...
        PacketType.Play.Server.SPAWN_ENTITY_EXPERIENCE_ORB, PacketType.Play.Server.ENTITY_VELOCITY,
        PacketType.Play.Server.REL_ENTITY_MOVE, PacketType.Play.Server.ENTITY_LOOK, 
     ...
     * @param destroyed  TRUE if the entity was killed, FALSE if it's merely unloading
     */
     ...
     * 
     * If the entity visible, it will be hidden. If it is hidden, it will become visible.
     *
     * @param observer  The player observer
